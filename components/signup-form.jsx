...
export default function SignupForm() {
  ...
  const { signup, getPendingProduct, clearPendingProduct } = useAuth()
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-muted-foreground">Join TECH STORE for exclusive offers</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-start gap-2">
          <input type="checkbox" required className="w-4 h-4 mt-0.5 rounded bg-muted border-none focus:ring-accent" />
